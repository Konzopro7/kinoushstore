...
MIDDLEWARE = [
    ...
    'shop.middleware.SiteVisitMiddleware',
...
STRIPE_CURRENCY = "cad"
STRIPE_LIVE_MODE = STRIPE_PUBLISHABLE_KEY.startswith("pk_live_") and STRIPE_SECRET_KEY.startswith("sk_live_")
STRIPE_PAYMENT_ENABLED = bool(STRIPE_PUBLISHABLE_KEY and STRIPE_SECRET_KEY) and (DEBUG or STRIPE_LIVE_MODE)
